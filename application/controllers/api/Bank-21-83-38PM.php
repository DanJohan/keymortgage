...
public function addUserBank(){
	...
	public function addUsrBank(){
		$this->form_validation->set_rules('user_id', 'User id', 'trim|required');
		$this->form_validation->set_rules('bank_name', 'Bank name', 'trim|required');
		$this->form_validation->set_rules('bank_domain', 'Bank Url domain', 'trim|required');
		$this->form_validation->set_rules('bank_branch', 'bank_branch', 'trim|required');
		...
		if ($this->form_validation->run() == true){
			...
			$insert_id = $this->InsertUserBankModel->insert($insert_data);
			if($insert_id){
				$response = array('status'=>true,'message'=>'Data inserted successfully!');
			}else{
				$response = array('status'=>false,'message'=>'Somthing went wrong!Please try again');
