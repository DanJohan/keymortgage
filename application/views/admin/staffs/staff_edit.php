      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <form method="post" action="<?= base_url('admin/staffs/edit/'.$user['id']); ?>" class="form-horizontal" enctype="multipart/form-data">
            ...
            <?php } ?>
			 ...
			 <div class="form-group">
                <div class="col-md-11">
                  <input type="submit" name="submit" value="updateStaff" class="btn btn-primary">
